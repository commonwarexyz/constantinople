...
/// close, `3` channel timeout). Lets the explorer distinguish a transfer from
/// a channel reservation, settlement, or reclaim; the
/// `value`/`counterparty`/`role` columns are interpreted in light of it.
