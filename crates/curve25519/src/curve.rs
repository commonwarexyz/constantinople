...
impl G {
    ...
    /// Converts this point to the affine representation used by mixed addition.
...
/// Returns the curve backend selected for signing operations on this host.
#[allow(clippy::missing_const_for_fn)] // x86 backend selection requires runtime feature detection.
pub fn backend_name() -> &'static str {
    #[cfg(all(target_arch = "x86_64", any(feature = "std", test)))]
    if avx512::Backend::new().is_some() {
        return "avx512";
    }
    #[cfg(target_arch = "aarch64")]
    {
