...
/// Read-only handles passed to capture and finalized observers.
pub type DatabaseReaders<E, H, T, S> = <Databases<E, H, T, S> as DatabaseSet<E>>::Readers;
...
pub type MerkleizedDatabases<E, H, S> = (
